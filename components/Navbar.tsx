      ...
      <div className="pointer-events-auto w-full md:w-auto">
        ...
        >
          ...
          <div className="flex items-center justify-between w-full md:w-auto">
            {/* Logo - Hidden Triple Click for Admin */}
            <div
              onClick={(e) => {
                if (e.detail === 3) { // 3 rapid clicks
                  onNavigate('admin');
                } else if (e.detail === 1) {
                  onNavigate('home');
                }
              }}
              className="text-xl md:text-2xl font-black tracking-tighter text-white z-50 cursor-pointer select-none"
            >
